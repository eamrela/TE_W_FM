...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "AlarmList.findAll", query = "SELECT a FROM AlarmList a")
    , @NamedQuery(name = "AlarmList.findByAlarmId", query = "SELECT a FROM AlarmList a WHERE a.alarmId = :alarmId")
    , @NamedQuery(name = "AlarmList.findByRecordId", query = "SELECT a FROM AlarmList a WHERE a.recordId = :recordId")
    , @NamedQuery(name = "AlarmList.findByAcknowledged", query = "SELECT a FROM AlarmList a WHERE a.acknowledged = :acknowledged")
    , @NamedQuery(name = "AlarmList.findByAdditionalText", query = "SELECT a FROM AlarmList a WHERE a.additionalText = :additionalText")
    , @NamedQuery(name = "AlarmList.findByAlarmType", query = "SELECT a FROM AlarmList a WHERE a.alarmType = :alarmType")
    , @NamedQuery(name = "AlarmList.findByAlarmDomain", query = "SELECT a FROM AlarmList a WHERE a.alarmDomain = :alarmDomain")
    , @NamedQuery(name = "AlarmList.findByManagedObject", query = "SELECT a FROM AlarmList a WHERE a.managedObject = :managedObject")
    , @NamedQuery(name = "AlarmList.findByAlarmNode", query = "SELECT a FROM AlarmList a WHERE a.alarmNode = :alarmNode")
    , @NamedQuery(name = "AlarmList.findByAlarmSeverity", query = "SELECT a FROM AlarmList a WHERE a.alarmSeverity = :alarmSeverity")
    , @NamedQuery(name = "AlarmList.findBySpecificProblem", query = "SELECT a FROM AlarmList a WHERE a.specificProblem = :specificProblem")
    , @NamedQuery(name = "AlarmList.findByEventTime", query = "SELECT a FROM AlarmList a WHERE a.eventTime = :eventTime")
    , @NamedQuery(name = "AlarmList.findByCeaseTime", query = "SELECT a FROM AlarmList a WHERE a.ceaseTime = :ceaseTime")
    , @NamedQuery(name = "AlarmList.findByAcknowledgeTime", query = "SELECT a FROM AlarmList a WHERE a.acknowledgeTime = :acknowledgeTime")
    , @NamedQuery(name = "AlarmList.findByAlarmComment", query = "SELECT a FROM AlarmList a WHERE a.alarmComment = :alarmComment")
    , @NamedQuery(name = "AlarmList.findByServiceAffecting", query = "SELECT a FROM AlarmList a WHERE a.serviceAffecting = :serviceAffecting")
    , @NamedQuery(name = "AlarmList.findByProbableCause", query = "SELECT a FROM AlarmList a WHERE a.probableCause = :probableCause")
    , @NamedQuery(name = "AlarmList.findByLoggingTime", query = "SELECT a FROM AlarmList a WHERE a.loggingTime = :loggingTime")
    , @NamedQuery(name = "AlarmList.findByTtId", query = "SELECT a FROM AlarmList a WHERE a.ttId = :ttId")})
public class AlarmList implements Serializable {
    ...
    public AlarmList(Long recordId) {
    ...
    public boolean equals(Object object) {
        ...
        AlarmList other = (AlarmList) object;
    ...
    public String toString() {
        return "com.te.fm.entities.AlarmList[ recordId=" + recordId + " ]";
    }
