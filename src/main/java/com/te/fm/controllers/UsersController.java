...
public class UsersController implements Serializable {
    ...
    @EJB
    private com.te.fm.beans.UsersFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle2").getString("UsersCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle2").getString("UsersUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle2").getString("UsersDeleted"));
        if (!JsfUtil.isValidationFailed()) {
