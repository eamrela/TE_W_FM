...
public class NodesController implements Serializable {
    ...
    @EJB
    private com.te.fm.beans.NodesFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle2").getString("NodesCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle2").getString("NodesUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle2").getString("NodesDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Nodes getNodes(java.lang.String id) {
    ...
    public static class NodesControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Nodes) {
                ...
                return getStringKey(o.getNodeName());
            } else {
